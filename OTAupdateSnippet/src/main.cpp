...
// Firmware URL
// const char *firmwareURL = "http://192.168.134.44:3000/firmware.bin";
const char *firmwareURL = "https://smartfarmingapp.cloud:3000/firmware.bin"; // https://smartfarmingapp.cloud:3000/OTAupdateBlink.bin
// Version file URL
// const char *versionURL = "http://192.168.120.192:3000/version.txt"; // Replace with your server version file URL
const char *versionURL = "https://smartfarmingapp.cloud:3000/version.txt"; // Replace with your server version file URL
...
void setup()
{
    ...
    pinMode(32, OUTPUT);
    delay(2000);
    Serial.println("Now I am version Doyel-0");
